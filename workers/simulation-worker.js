...
_.extend(Gene.prototype, {
  copy: function (mutationRate, spread) {
    ...
    if (prob.gamble(mutationRate) && this.max-this.min > 0) {
      while (mutated === value) {
        var change = Math.max(Math.random()*spread, 1);
        var added = this.getValue(value+change);
        var subtr = this.getValue(value-change);
...
},{"./probability":6,"underscore":2}],4:[function(require,module,exports){
"use strict";
...
},{"./gene":3,"underscore":2}],5:[function(require,module,exports){
"use strict";
...
},{"./gene":3,"./genome":4,"underscore":2}],6:[function(require,module,exports){
"use strict";
module.exports = {
...
// 
// sim.start();
},{"./genome":4,"./organism":5,"./probability":6,"asEvented":1,"underscore":2}],8:[function(require,module,exports){
"use strict";
